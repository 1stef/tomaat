...
CREATE TABLE `tijdslot` (
  ...
  `baannummer` int(11) DEFAULT NULL,
  `slotnummer` int(11) DEFAULT NULL,
  `starttijd` varchar(45) DEFAULT NULL,
  `eindtijd` varchar(45) DEFAULT NULL,
  `vrij` tinyint(4) DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26148 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
-- Dump completed on 2021-12-10 11:24:39
